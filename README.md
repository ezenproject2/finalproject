...
<p>복잡한 수치와 데이터 처리를 필요로 하는 결제 기능이 쉽지만은 않았습니다. 감사하게도 자료를 남겨준 선배 개발자들, 공식 문서, 다른 사람들이 있기에 제 몫을 마칠 수 있었다고 생각합니다.
기획부터 구현까지의 모든 과정을 망라하는 최종 프로젝트를 통해 크게 성장했다고 느낍니다. 지금의 경험을 초석으로 삼아 개발에 더욱 정진하고 싶습니다.</p>
