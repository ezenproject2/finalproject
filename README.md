  ...
  <table style="width: 100%; border-collapse: collapse; text-align: center;">
    ...
    <tbody>
      ...
      <tr>
        ...
        <td style="border: 1px solid #c6c6c6; padding: 8px;">
          <a href="/">https://atlantic-cannon-0d5.notion.site/_-1b93a64417ac81718b46d130877d457c</a>
        </td>
      </tr>
      <tr>
...
<h2 style="display: flex; align-items: center;">
  <span style="display: inline-block; width: 5px; height: 20px; background-color: #c6c6c6; margin-right: 10px;"></span>개발 기간
</h2>
<br>
<p>2024.12.02 - 2025.01.08 (5주) </p>
<br><br><br>
...
<h2 style="display: flex; align-items: center;">
  <span style="display: inline-block; width: 5px; height: 20px; background-color: #c6c6c6; margin-right: 10px;"></span>프로젝트 후기
</h2>
<br>
<p><strong>📕 차민주</strong></p>
<p>
  이번 프로젝트에서 조장으로서 체계적인 스케줄을 바탕으로 개발을 이끌며 협업의 중요성을 깊이 느꼈습니다. 
  백엔드 개발자로서 프론트엔드 개발자와의 협력을 통해 요구사항 소통 방식과 상호 이해를 배울 수 있었습니다. 
  또한, 대량의 도서 데이터를 처리하며 데이터 처리 능력에 자신감을 얻었고, 다양한 API와 라이브러리를 활용하며 웹 개발 과정에서 생기는 다양한 문제 해결 방식을 학습 익히는 값진 경험을 했습니다. 
  이 프로젝트를 통해 기술 역량과 협업 능력을 한층 성장시킬 수 있었습니다.
</p>
<p><strong>📘 지윤희</strong></p>
<p>이번 프로젝트를 진행하면서 가장 중요하다고 느낀 것은 팀원과의 협업과 소통이었습니다. 초기 회의에서 역할 분배와 설계 규칙을 명확히 정리하는 것이 프로젝트 진행에 큰 도움이 될 거 같다고 느꼈습니다.
또한, 다뤄본 적 없는 API를 사용하면서 많은 어려움을 겪었고, 처음에는 어떻게 접근해야 할지 몰라 시간이 많이 소요되었습니다. 이 경험을 통해 API에 대해 더 깊이 공부하고 익혀야겠다는 필요성을 느꼈습니다.
프로젝트를 진행하는 동안 예상치 못한 자잘한 오류들이 자주 발생했는데, 이를 간과하지않고 철저히 점검하는 것이 얼마나 중요한지 깨닫게 되었습니다. 이러한 경험들이 모두 성장으로 이어졌고, 프로젝트를 통해 많은 것을 배우고 한층 더 발전할 수 있었습니다.</p>
<p><strong>📒 박준희</strong></p>
<p>돈을 다루는 결제 및 환불 API는 엄밀한 정확도와 안정성을 요구하기에 개발하는 과정이 순탄하지만은 않았습니다. 감사하게도 선배 개발자들이 남긴 자료, 공식 문서, 협력하는 팀원들이 있었기에 제 몫을 무사히 마칠 수 있었다고 생각합니다.
기획부터 화면과 서버를 아우르는 개발 모두에 참여하며 프로젝트의 도메인을 이해 및 구현하는 능력과 협업 능력 등 개발자에게 필요한 전반적인 역량을 기를 수 있었음을 실감합니다. 지금의 경험을 초석으로 하여 앞으로 지속적으로 성장하고 전문성을 기르는 개발자가 되겠습니다.</p>
<p><strong>📙 정슬빛</strong></p>
<p>이번 프로젝트를 통해 처음으로 큰 규모의 웹 사이트 설계 및 디자인을 총괄하는 경험을 하였습니다. 서점 사이트를 이용하는 사용자 입장을 생각하며 구조를 설계하고 디자인 방향성을 설정하는 과정이 프론트엔드를 꿈꾸는 제게 있어 매우 의미 있는 시간이였습니다. 
  프로젝트 진행 중 요구사항 변경이나 예상치 못한 수정 작업이 발생하기도 했지만, 팀원들과 상황에 맞게 문제를 조율하며 해결할 수 있었습니다. 프로젝트 막바지에 데이터가 모두 반영된 화면이 구현된 것을 확인하며 큰 보람을 느꼈습니다. 
  팀 프로젝트를 수행하며 팀원들과의 소통 능력을 기를 뿐만 아니라 사용자의 요구를 더욱 깊게 이해하고 경험을 도울 수 있는 프론트엔드가 되고자 다짐하게 되었습니다.</p>
<br><br><br>
